...
#include <stdio.h>
/**
 * swap - change two vals in ascending or descending order
 * @arr: array
 * @item1: item one
 * @item2: item two
...
/**
 * merge - sort The bitonic in an recursive orders
 * @arr: An array
 * @low: The 1st elem
 * @nelemnt: The elemnumber
 * @order: The ascending order 1, The descending order Zero
 */
 ...
 * @arr: An array
 * @low: The 1st  elem
 * @nelemnt: The number of elem
 * @order: The ascending order of 1, the descending order Zero
...
/**
 * bitonic_sort - pre the terrain to bitonic the sort algorithm
 * @array: An array
 * @size: The array lenght
 */
